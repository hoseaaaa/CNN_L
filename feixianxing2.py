...
def create_dataset():
    ...
    x1_dict = [0.25, 0.3, 0.375, 0.5, 0.75, 0.04, 0.1, 0.2, 0.275, 0.285, 0.38, 0.4, 0.41, 0.42, 0.43, 0.45, 0.46, 0.47, 0.48, 0.49, 0.52, 0.54, 0.6, 0.7, 
            0.25, 0.3, 0.375, 0.5, 0.75, 0.04, 0.1, 0.2, 0.275, 0.285, 0.38, 0.4, 0.41, 0.42, 0.43, 0.45, 0.46, 0.47, 0.48, 0.49, 0.52, 0.54, 0.6,0.7,  
            0.25, 0.3, 0.375, 0.5, 0.75, 0.04, 0.1, 0.2, 0.275, 0.285, 0.38, 0.4, 0.41, 0.42, 0.43, 0.45, 0.46, 0.47, 0.48, 0.49, 0.52, 0.54, 0.6,0.7]

    x2_dict = [4125504, 4125504, 4125504, 4125504, 4125504, 4125504, 4125504, 4125504, 4125504, 4125504, 4125504, 4125504, 4125504, 4125504, 4125504, 4125504, 4125504, 4125504, 4125504, 4125504, 4125504, 4125504, 4125504, 4125504,
            21469972, 21469972, 21469972, 21469972, 21469972, 21469972, 21469972, 21469972, 21469972, 21469972, 21469972, 21469972, 21469972, 21469972, 21469972, 21469972, 21469972, 21469972, 21469972, 21469972, 21469972, 21469972, 21469972, 21469972,
            39072262, 39072262, 39072262, 39072262, 39072262, 39072262, 39072262, 39072262, 39072262, 39072262, 39072262, 39072262, 39072262, 39072262, 39072262, 39072262, 39072262, 39072262, 39072262, 39072262, 39072262, 39072262, 39072262, 39072262]

    y_dict = y_data = [ 2.996, 2.925, 2.785, 3.14, 2.732, 3.105, 3.1, 2.994, 3.003, 2.909, 2.656, 6.997, 2.948, 2.942, 2.709, 2.755, 2.778, 2.764, 2.881, 2.864, 2.765, 2.942, 3.157, 2.654,
            29.665, 20.528, 22.918, 22.064, 33.344, 40.896, 28.018, 35.475, 21.383, 24.133, 24.346, 25.162, 22.463, 22.444, 27.292, 21.253, 21.476, 27.447, 25.247, 21.102, 22.319, 24.646, 21.638, 22.174,
            57.048, 54.732, 53.781, 57.674, 65.929, 72.752, 64.068, 53.42, 56.189, 59.388, 57.791, 54.098, 54.669, 55.572, 53.694, 59.278, 56.652, 55.851, 57.967, 56.959, 53.932, 60.112, 59.897, 64.104]

    x_tensor = torch.tensor(list(zip(x1_dict, x2_dict)))
...
if __name__ == '__main__':
    ...
    x1_values = torch.linspace(0, 1, 1000)
    x2_fixed_value = 51173098
    loaded_net.eval()
